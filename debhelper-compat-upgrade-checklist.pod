...
B<Retroactively applied to earlier compat levels>: The build system
was removed in debhelper/13.21 after the removal of Python2 from
Debian. The build system stopped working, since it was only applicable
to Python2 packaging.
